...
Behaviours framework written in JavaScript implementing [Behaviour-first-design](https://github.com/ahmedragab/Behaviour-first-design/wiki) and queue-map architecture as part of [BeamJS](https://github.com/QuaNode/beamjs).
