...
var getInputObjectsReturn = function (objects, superProperty, getSubProperty, getInputObject) {
    ...
    return function () {
        ...
        var push = function (index, inputObjects) {
            ...
            setTimeout(function () {
                ...
                getInputObject(objects[index], superProperty,
                    getSubProperty)(function (inputObject) {
        ...
        } else if (objects) getInputObject(objects, superProperty,
            getSubProperty)(function (inputObject) {
...
var getInputObjectReturn = function (object, superProperty, getSubProperty, getProperty, relate,
    ...
    return function () {
        ...
        businessObjectMapping.map(inputObject, object, true,
            superProperty, getSubProperty || getProperty);
        if (relate) {

            businessObjectMapping.relate(inputObject, object,
                superProperty, getInputObjects, getInputObject,
    ...
    return function () {
        ...
        var push = function (index, businessObjects) {
            ...
            setTimeout(function () {
                ...
                getBusinessObject(objects[index], superProperty,
...
var mapObjects = function (fromObjects, getBusinessObjectFunc, callback) {
    ...
    return function (getIdentificationAttributes, setBusinessObjects) {
        ...
        var getBusinessObjects = function (objects, superProperty, getSubProperty) {
            ...
            return getBusinessObjectsReturn(objects, superProperty,
                getSubProperty, getBusinessObject);
        };
        var getBusinessObject =
            getBusinessObjectFunc(getBusinessObjects, getIdentificationAttributes);
        if (typeof setBusinessObjects === 'function') (Array.isArray(fromObjects) ?
            getBusinessObjects : getBusinessObject)(fromObjects)(function (toObjects) {
...
var getBusinessObjectReturn_To = function (object, superProperty, getSubProperty, getProperty,
    ...
    return function () {
        ...
        var businessObject = {};
        var businessObjectMapping = new BusinessObjectMapping();
        businessObjectMapping.map(businessObject, object, true,
            superProperty, getSubProperty || getProperty);
        businessObjectMapping.relate(businessObject, object,
            superProperty, getBusinessObjects, getBusinessObject,
            getSubProperty || getProperty)(function () {
...
var getBusinessObjectReturn_Between = function (object, superProperty, getSubProperty, getProperty,
    ...
    return function () {
        ...
        var businessObject = {};
        var businessObjectMapping = new BusinessObjectMapping();
        businessObject = (Array.isArray(inputObjects) ? inputObjects :
            [inputObjects]).filter(function (inputObject) {

                return typeof getIdentificationAttributes === 'function' &&
                    getIdentificationAttributes().every(function (idAttr) {

                        return object && businessObjectMapping.getAttributeValue(inputObject,
                            getSubProperty || getProperty, idAttr, superProperty) === object[idAttr];
                    });
            })[0];
        businessObjectMapping.map(businessObject, object, false,
            superProperty, getSubProperty || getProperty);
        businessObjectMapping.deepMap(businessObject, object,
            superProperty, getSubProperty || getProperty);
        if (typeof cb === 'function') cb(businessObject);
    };
};
...
BusinessOperationDelegate.prototype.mapFromObjects =
    function (fromObjects, getProperty, relate, callback) {
        ...
        return function (setInputObjects) {
            ...
            var getInputObject = function (object, superProperty, getSubProperty) {
                ...
                return getInputObjectReturn(object, superProperty, getSubProperty,
                    getProperty, relate, getInputObjects, getInputObject);
            };
            if (typeof setInputObjects === 'function')
                getInputObjects(fromObjects)(function (inputObjects) {
...
BusinessOperationDelegate.prototype.mapBetweenObjects =
    function (fromObjects, inputObjects, getProperty, callback) {

        return mapObjects(fromObjects, function (getBusinessObjects, getIdentificationAttributes) {

            var getBusinessObject = function (object, superProperty, getSubProperty) {

                return getBusinessObjectReturn_Between(object, superProperty,
                    getSubProperty, getProperty, inputObjects, getIdentificationAttributes);
            };
            return getBusinessObject;
        }, callback);
    };
